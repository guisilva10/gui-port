...
export function AnimatedBeamHome() {
  ...
  return (
    <div className="relative mx-auto mb-20 p-8 flex items-center justify-center flex-col">
      <h2 className="mx-auto max-w-2xl text-3xl font-bold tracking-tight sm:text-4xl">
        Presença Digital
      </h2>
      <p className="font-semibold leading-7 text-center text-primary text-sm">
        Cada ferramenta representa o que você precisa ter para ter uma marca de
        sucesso.
      </p>
      <div
        className="relative flex h-[500px] w-full items-center justify-center overflow-hidden bg-background flex-col lg:flex-row p-10 md:shadow-xl"
        ref={containerRef}
      >
        <RetroGrid />
