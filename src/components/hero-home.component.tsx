      ...
      <div className="relative z-10 w-full items-center">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl italic text-muted-foreground lg:text-lg">
            Dê vida às suas ideias com a nossa equipe. Nós transformamos suas
            visões em conquistas digitais, oferecendo soluções sob medida e
            inovadoras para o sucesso do seu negócio
          </p>
        </div>
        <div className="flex items-center justify-center mt-10 gap-4">
          ...
          <Button variant="outline" className="font-normal text-sm" asChild>
            <Link href="https://thaiza-nogueira.vercel.app/" target="_blank">
              Thaiza Nogueira
              <ChevronRight />
            </Link>
          </Button>
